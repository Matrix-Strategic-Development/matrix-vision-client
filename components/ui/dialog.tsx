...
export const dialogContentStaticClasses =
  "grid gap-4 border bg-background text-card-foreground p-4 shadow-lg rounded-lg";
...
export const dialogDescriptionStaticClasses = "text-sm text-muted-foreground";
